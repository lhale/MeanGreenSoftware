 ...
 *
 *   $Id: posting.php 192 2007-01-20 15:17:44Z kronos $
 *
 *
 ***************************************************************************/
...
$msg_icon = ($HTTP_POST_VARS['postimageselect']) ? $HTTP_POST_VARS['postimageselect'] : 0;
...
// Begin PNphpBB2 Module (Message Icons) (Limited post edit time MOD)
//		$select_sql = ( !$submit ) ? ", t.topic_title, p.enable_bbcode, p.enable_html, p.enable_smilies, p.enable_sig, p.post_username, pt.post_subject, pt.post_text, pt.bbcode_uid, u.username, u.user_id, u.user_sig" : '';
		$select_sql = ( !$submit ) ? ", t.topic_title, p.enable_bbcode, p.enable_html, p.enable_smilies, p.enable_sig, p.post_username, p.post_time, pt.post_subject, pt.post_text, pt.bbcode_uid, u.username, u.user_id, u.user_sig, p.post_icon" : '';
// End PNphpBB2 Module (Message Icons) (Limited post edit time MOD)
...
// Begin PNphpBB2 Module (Message Icons)
		$preview_msg_icon = ( $msg_icon == 0) ? "&nbsp;" : "<img " . $board_config['posticons_size'] . " src=\"" . $board_config['path_posticons'] . "/image_" . $msg_icon . ".gif\" alt=\"" . $msg_icon . "\" border=\"0\">";
// End PNphpBB2 Module (Message Icons)
...
/*			'POSTER_NAME' => $preview_username, */
			'POSTER_NAME' => pnVarPrepForDisplay($preview_username),
/* End PNphpBB2 Module */
...
if ($forum_id)
{
	...
	{
		message_die(GENERAL_ERROR, 'Catégorie inexistante', '', __LINE__, __FILE__, $sqlw);
	}
...
{
// Begin PNphpBB2 Module
	$topic_title = '<a href="' . append_sid('viewtopic.'.$phpEx.'?t='.$topic_id) . '" class="maintitle">'.$topic_title.'</a>';
// End PNphpBB2 Module
}
