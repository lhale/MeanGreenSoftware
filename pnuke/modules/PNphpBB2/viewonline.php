 ...
 *
 *   $Id: viewonline.php 192 2007-01-20 15:17:44Z kronos $
 *
 *
 ***************************************************************************/
...
//			$username = $row['username'];
			$username = pnVarPrepForDisplay($row['username']);
// End PNphpBB2 Module
...
//				$username = '<b style="color:#' . $theme['fontcolor3'] . '">' . $username . '</b>';
				$username = '<b style="color:#' . $phpbb_theme['fontcolor3'] . '">' . $username . '</b>';
// End PNphpBB2 Module
			}
...
//				$username = '<b style="color:#' . $theme['fontcolor2'] . '">' . $username . '</b>';
				$username = '<b style="color:#' . $phpbb_theme['fontcolor2'] . '">' . $username . '</b>';
// End PNphpBB2 Module
			}
...
//		$row_class = ( $$which_counter % 2 ) ? $theme['td_class1'] : $theme['td_class2'];
		$row_color = ( $$which_counter % 2 ) ? $phpbb_theme['td_color1'] : $phpbb_theme['td_color2'];
		$row_class = ( $$which_counter % 2 ) ? $phpbb_theme['td_class1'] : $phpbb_theme['td_class2'];
// End PNphpBB2 Module
