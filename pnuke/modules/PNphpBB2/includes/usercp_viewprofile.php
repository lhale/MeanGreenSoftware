...
$profiledata = phpbb_get_userdata($HTTP_GET_VARS[POST_USERS_URL]);
// End PNphpBB2 Module
...
//			$rank_image = ( $ranksrow[$i]['rank_image'] ) ? '<img src="' . $ranksrow[$i]['rank_image'] . '" alt="' . $poster_rank . '" title="' . $poster_rank . '" border="0" /><br />' : '';
			$rank_image = ( $ranksrow[$i]['rank_image'] ) ? '<img src="' . get_rank_image($ranksrow[$i]['rank_image']) . '" alt="' . $poster_rank . '" title="' . $poster_rank . '" border="0" /><br />' : '';
// End PNphpBB2 Module
		}
	}
}
...
if ( empty($attach_config['disable_mod']) )
{
...
/*	'USERNAME' => $profiledata['username'], */
	'USERNAME' => pnVarPrepForDisplay($profiledata['username']),
/* End PNphpBB2 Module */
...
/*	'L_ABOUT_USER' => sprintf($lang['About_user'], $profiledata['username']), */
	'L_VIEWING_PROFILE' => sprintf($lang['Viewing_user_profile'], pnVarPrepForDisplay($profiledata['username'])), 
	'L_ABOUT_USER' => sprintf($lang['About_user'], pnVarPrepForDisplay($profiledata['username'])), 
/* End PNphpBB2 Module */
...
/*	'L_SEARCH_USER_POSTS' => sprintf($lang['Search_user_posts'], $profiledata['username']),  */
	'L_SEARCH_USER_POSTS' => sprintf($lang['Search_user_posts'], pnVarPrepForDisplay($profiledata['username'])), 
/* End PNphpBB2 Module */
