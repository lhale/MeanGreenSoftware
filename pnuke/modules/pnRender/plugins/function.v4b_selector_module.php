 ...
 *
 * @author	Robert Gasch
 * @version     $Id: function.v4b_selector_module.php,v 1.2 2004/12/28 23:08:31 rgasch Exp $
...
function smarty_function_v4b_selector_module ($params, &$smarty) 
{
    require_once ('includes/v4blib/HtmlUtil.class.php');
    return HtmlUtil::getSelector_PNModule ($params['name'], $params['selectedValue'], 
