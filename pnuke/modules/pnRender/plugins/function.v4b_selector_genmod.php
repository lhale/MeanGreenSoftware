 ...
 * 
 */
function smarty_function_v4b_selector_genmod($params, &$smarty) 
{
    ...
    return HtmlUtil::getSelector_CategoryField ('/__SYSTEM__/General/GenMod', $name, 'id', 
                                                $selectedValue, $defaultValue, $defaultText, 
                                                $lang, $submit, $excludeList, $onchange);
}
?>