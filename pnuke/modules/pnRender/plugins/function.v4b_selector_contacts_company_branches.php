 ...
 *
 * @author	Robert Gasch
 * @version     $Id: function.v4b_selector_contacts_company_branches.php,v 1.1 2005/01/21 11:10:20 rgasch Exp $
...
function smarty_function_v4b_selector_contacts_company_branches ($params, &$smarty) 
{
    return HtmlUtil::getSelector_contactCompanyBranches ($params['cid'], $params['name'], 
                     $params['selectedValue'], $params['defaultValue'], $params['defaultText'],
