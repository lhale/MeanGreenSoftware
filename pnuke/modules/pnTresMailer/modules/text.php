<?php
// $Id: text.php,v 1.2 2005/11/07 21:57:30 jazzie Exp $
// ----------------------------------------------------------------------
...
// variable that need to be defined for the system
	$modversion['file_name'] = 'text'; // the name of this php file
	...
	$modversion['function_name'] = 'text'; // the name of the function listed below
	$modversion['description'] = 'Text Area'; // brief description of this module
...
function text_html($mod_id, $nl_url, $ModName) {
...
function text_text($mod_id, $nl_url, $ModName) {
	global $prefix, $pntable;
	$dbconn =& pnDBGetConn(true);
	        $pntable =& pnDBGetTables();
...
function text_admin($mod_id, $ModName) {
	global $prefix, $pntable;
	$dbconn =& pnDBGetConn(true);
	        $pntable =& pnDBGetTables();
