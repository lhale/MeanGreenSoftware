<?php
// $Id: pnTresMailer_hide.php,v 1.3 2005/12/28 11:25:59 kdoerges Exp $
// ----------------------------------------------------------------------
...
* Block Information *
*********************/
function pnTresMailer_pntresmailer_hideblock_info()
{
    return array('text_type'      => 'pnTresMailer',
                 'module'         => 'pnTresMailer',
                 'text_type_long' => 'NewsLetter Subscription Block Hidden to Subscribed',
                 'allow_multiple' => true,
                 'form_content'   => false,
                 'form_refresh'   => false,
                 'show_preview'   => true);
...
* Block permission  *
*********************/
function pnTresMailer_pntresmailer_hideblock_init()
{
    pnSecAddSchema('pnTresMailer:pntresmailer_hideblock:', 'Block title::');
}
...
* Display function  *
*********************/
function pnTresMailer_pntresmailer_hideblock_display($blockinfo) {
// get vars		
    $prefix = pnConfigGetVar('prefix');		
    $lang = pnSessionGetVar('lang');

    if (!pnSecAuthAction(0,
                         'pnTresMailer:pntresmailer_hideblock:',
                         "$blockinfo[title]::",
                         ACCESS_READ)) {
        return;
    }
