<?php /* Smarty version 2.6.14, created on 2007-10-09 10:09:01
         compiled from default/views/global/navigation.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/global/navigation.html', 2, false),array('function', 'pc_form_nav_open', 'default/views/global/navigation.html', 21, false),array('function', 'pc_filter', 'default/views/global/navigation.html', 26, false),array('function', 'pc_date_select', 'default/views/global/navigation.html', 29, false),array('function', 'pc_url', 'default/views/global/navigation.html', 38, false),)), $this); ?>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td nowrap valign="bottom" align="left">
		 	<?php echo smarty_function_pc_filter(array('label' => $this->_config[0]['vars']['_PC_FILTER_LABEL'],'class' => "",'type' => "user,category,topic",'order' => "user,category,topic,jump"), $this);?>
<br />
			<?php echo smarty_function_pc_date_select(array('day' => 'on','month' => 'on','year' => 'on','view' => 'on','label' => $this->_config[0]['vars']['_PC_JUMP_MENU_LABEL'],'order' => "month,day,year,view,jump"), $this);?>
