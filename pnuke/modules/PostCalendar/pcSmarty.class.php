<?php
/**
 *  $Id: pcSmarty.class.php,v 1.2 2006/01/31 10:40:36 larsneo Exp $
 *
...
class pcSmarty extends Smarty
{
    ...
    $this->plugins_dir = array( "modules/$pcDir/plugins", //set our path first
                                "plugins" //Smarty's second
                                );		
    //array_push($this->plugins_dir,"modules/$pcDir/pnincludes/Smarty/plugins");
		...
		$this->assign('TPL_IMAGE_PATH',"modules/$pcDir/pntemplates/$template_name/images");
