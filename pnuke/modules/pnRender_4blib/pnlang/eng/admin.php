...
define('_PNRENDER_CACHE_LIFETIME_UNIT',  'seconds');
define('_PNRENDER_CLEAR_CACHED',	     'Delete cached pages');
define('_PNRENDER_CACHE_CLEARED',	     'Cache deleted');

define('_PNRENDER_CONFIG_UPDATED',	     'Configuration updated');
define('_PNRENDER_OK', 				     'Confirm changes');

define('_PNRENDER_NOAUTH',			     'Sorry! You do not have authorization to administer pnRender');
?>