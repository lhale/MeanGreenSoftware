 ...
 *
 * @author	Robert Gasch
 * @version     $Id: function.v4b_selector_contacts_company.php,v 1.1 2005/01/21 11:10:20 rgasch Exp $
...
function smarty_function_v4b_selector_module_tables ($params, &$smarty) 
{
    require_once ('includes/v4blib/HtmlUtil.class.php');
    return HtmlUtil::getSelector_ModuleTables ($params['modname'], $params['name'], $params['selectedValue'], 
                                               $params['defaultValue'], $params['defaultText'], $params['submit'], 
                                               $params['remove'], $paramsp['disabled'], $params['nStripChars']);
}
