...
function smarty_function_v4b_meta_generator ($params, &$smarty) 
{
    include('personal_config.php');
    $generator = "PostNuke - http://postnuke.com - " . $v4bConfig[V4B_OS_RELEASE_NAME] . " " . $v4bConfig[V4B_OS_RELEASE_VERSION] . " - " . $v4bConfig[V4B_OS_RELEASE_HOME];
    return $generator;
}
