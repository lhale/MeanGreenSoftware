 ...
 */ 
function smarty_function_v4b_assign_arrayval ($params, &$smarty) 
{
    if (!$params['name'])
      exit ('smarty_function_v4b_assign: invalid name passed ...');

    if (!$params['array'])
      exit ('smarty_function_v4b_assign: invalid array passed ...');

    if (!$params['key'])
      exit ('smarty_function_v4b_assign: invalid key passed ...');

    $val = $params['array'][$params['key']];
