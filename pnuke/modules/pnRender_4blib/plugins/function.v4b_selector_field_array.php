 ...
 * 
 */
function smarty_function_v4b_selector_field_array ($params, &$smarty) 
{
    ...
    return HtmlUtil::getSelector_FieldArray ($modname, $table, $name, $field, $where, $sort, $selectedValue, 
                                             $defaultValue, $defaultText, $assocKey, $distinct, $submit, $disabled, $onchange);
}
?>