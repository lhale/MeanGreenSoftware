...
function smarty_function_v4b_selector_table_fields ($params, &$smarty) 
{
    require_once ('includes/v4blib/HtmlUtil.class.php');
    return HtmlUtil::getSelector_TableFields ($params['modname'], $params['tablename'], $params['name'], 
                                              $params['selectedValue'], $params['defaultValue'], 
					      $params['defaultText'], $params['submit']);
}
