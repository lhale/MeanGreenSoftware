...
/**
 * v4b_selector_group: generate a PN Group selector
 *
 * @author	Robert Gasch
 * @version     $Id: function.v4b_selector_group.php,v 1.2 2004/12/28 23:08:31 rgasch Exp $
...
function smarty_function_v4b_selector_group ($params, &$smarty) 
{
    require_once ('includes/v4blib/HtmlUtil.class.php');
    return HtmlUtil::getSelector_PNGroup ($params['name'], $params['selectedValue'], 
                                         $params['defaultValue'], $params['defaultText'],
                                         $params['includeAll'], $params['allText'], $params['ignore']);
}
