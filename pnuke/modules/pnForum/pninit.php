 ...
 *
 * initialize module
 * @version $Id: pninit.php,v 1.30 2005/11/23 14:08:02 landseer Exp $
...
//    pnSessionSetVar('upgrade_to_2_6_done', 0);
    ...
    // LDH - MyISAM type needed for FULLTEXT indexing
    ...
    $sql = "CREATE TABLE $pnforumtopicstable (
            ...
            KEY forum_id (forum_id),
            KEY topic_last_post_id (topic_last_post_id)) TYPE=MyISAM";
    $result = pnfExecuteSQL($dbconn, $sql, __FILE__, __LINE__);
    pnfCloseDB($result);
