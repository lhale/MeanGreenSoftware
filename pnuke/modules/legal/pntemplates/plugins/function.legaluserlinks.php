...
function smarty_function_legaluserlinks($params, &$smarty) 
{
    ...
    if (pnSecAuthAction(0, 'legal::', 'refundpolicy::', ACCESS_OVERVIEW) && pnModGetVar('legal', 'refundpolicy')) {
		$adminlinks .= "$seperator <a href=\"" . pnVarPrepHTMLDisplay(pnModURL('legal', 'user', 'refunds')) . "\">" . _LEGALREFUNDPOLICY . "</a> ";
    }
