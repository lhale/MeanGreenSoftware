...
define('_PGCONFIGEDITORUNDO', 'Tillad undo i editor (fjerner statusbjælke)');
...
define('_PGCONFIRMLISTDELETE', 'Er du helt sikker på at du vil slette denne kategori?');
define('_PGCONFIRMPUBTYPEDELETE', 'Er du helt sikker på at du vil slette denne publikationstype - inklusiv alle publikationer?');
define('_PGCREATETEMPLATES', 'Vælg skabeloner til auto-generering');
...
define('_PGDOWNLOADINGSCHEMA', 'Pagesetter XML schemaet downloader. Hvis der ikke sker noget efter et par sekunder, så klik på dette link');
...
define('_PGFOLDERSETUP','Opsætning til brug for Folder-modulet');
...
define('_PGFOLDERSTRANSFERED', 'Alle publikationer er nu overført til Folder modulet');
...
define('_PGIMPORTARTICLEDESC', 'Opretter en ny publikationstype der kan håndtere simple artikler med overskrift, tekst og billede.');
...
define('_PGIMPORTFILEUPLOADDESC', 'Opretter en ny publikationstype der kan håndtere generiske fileuploads. Typen er designet til brug sammen med "Folder" modulet.');
define('_PGIMPORTIMAGE', 'Opret Image');
define('_PGIMPORTIMAGEDESC', 'Opretter en ny publikationstype der kan håndtere billeder. Typen er designet til brug sammen med "Folder" modulet.');
...
define('_PGIMPORTNEWSEXTRA', 'Tilføj billedfelt');
define('_PGIMPORTNOTE', 'Opret Note');
define('_PGIMPORTNOTEDESC', 'Opretter en ny publikationstype der kan håndtere små noter. Typen er designet til brug sammen med "Folder" modulet.');
...
define('_PGIMPORTXMLSCHEMADESC', 'Opretter en ny publikationstype på baggrund af den uploaded Pagesetter XML schema.');
...
define('_PGLISTSETUP', 'Listeopsætning');
define('_PGLISTSHOWCOUNT', 'Antal sider der skal vises i listen');
define('_PGLISTTITLE', 'Overskrift');
define('_PGMISSINGFIELDROW', 'Du skal oprette mindst ét felt');
define('_PGNAME', 'Navn');
...
define('_PGONLYONEPAGEABLE', 'Kun ét felt kan markeres som flersiders!');
...
define('_PGPUBLICATIONTYPEEDIT', 'Publikationstype opsætning');
...
define('_PGPUBTYPEEDITADDSTEP1', 'Trin 1: Vælg navn og eventuelt beskrivelse for din nye publikation.');
define('_PGPUBTYPEEDITADDSTEP2', 'Trin 2: Opret felter for publikationstypen.');
define('_PGPUBTYPEEDITADDSTEP2NOTE', 'Klik [+] for at tilføje felter under tilsvarende række. Gentag indtil at du har til føjet alle de felter du ønsker. Listen af felter kan altid rettes senere.');
...
define('_PGPUBTYPEEDITCOLINFO', 'P = Påkrævet, S = Søgbar, FS = Flere sider');
define('_PGPUBTYPESHELP', '<p>I dette vindue kan du tilføje nye publikationstyper (f.eks.
nyheder, opskrifter eller artikler).</p>
<p>Klik på "Ny publikationstype" for at definere hvilke database felter 
din publikationstype skal bestå af (f.eks. en overskrift, introtekst og 
fuldtekst for en nyhedstype).</p>
<p>Du kan også installere <em>prædefinerede publikationstyper</em>. Klik
på menuen "Funktioner:Importer data" for at få en oversigt over mulighederne.</p>');
define('_PGREL_PUBLICATION_SELECT', 'Publikationstype');
define('_PGREL_FIELD_SELECT', 'Felt');
define('_PGREL_STYLE_SELECT', 'Udvælgertype');
...
define('_PGSORTFIELD1', 'Første sorteringsnøgle');
define('_PGSORTFIELD2', 'Anden sorteringsnøgle');
define('_PGSORTFIELD3', 'Tredie sorteringsnøgle');
define('_PGDEFAULTFILTER', 'Standard filter');
define('_PGSETUPFOLDER', 'Overfør Pagesetter publikationer til Folder modulet'); //
define('_PGSETUPFOLDERNONESEL', 'Der er ikke valgt nogen standardmappe. Disse publikationer kan ikke overføres til Folder modulet.');
...
define('_PGVALUE', 'Værdi');
define('_PGWFCFGLIST', 'Workflowopsætning - vælg publikationstype');
define('_PGWFCFG', 'Workflowopsætning');
