<?php
// $Id: config.php 16107 2005-04-18 20:03:23Z lcabrera $
// ----------------------------------------------------------------------
...
// $pnconfig['dbhost'] = 'lhale.startlogicmysql.com';
$pnconfig['dbhost'] = 'localhost';
// $pnconfig['dbuname_root'] = 'cm9vdA==';
// $pnconfig['dbpass_root'] = 'aGVsbG8=';
// current Startlogic - $pnconfig['dbuname'] = 'bWVhbmdyZWVu==';
// current Startlogic - $pnconfig['dbpass'] = 'bWVhbmFuZGdyZWVu=';
$pnconfig['dbuname'] = 'root';
$pnconfig['dbpass'] = '';
$pnconfig['dbname'] = 'meangreen';
$pnconfig['system'] = '1';
$pnconfig['prefix'] = 'pn';
// current Startlogic - $pnconfig['encoded'] = '1';
$pnconfig['encoded'] = '0';
$pnconfig['pconnect'] = '0';
