<?php /* Smarty version 2.6.14, created on 2007-12-03 16:56:06
         compiled from eng/legal_user_accessibilitystatement.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'pnconfiggetvar', 'eng/legal_user_accessibilitystatement.htm', 4, false),)), $this); ?>
...
<p>This is the official accessibility statement for <?php echo smarty_function_pnconfiggetvar(array('name' => 'sitename'), $this);?>
. If you have any questions or comments, please feel free to e-mail the site administrator at <?php echo smarty_function_pnconfiggetvar(array('name' => 'adminmail'), $this);?>
.</p>
<h2>Access keys</h2>
<p>Most browsers support jumping to specific links by typing keys defined on the web site. Under the Microsoft Windows operating system, you can press Alt + an access key; on an Apple Macintosh operating system, you can press Control + an access key.</p>
<p>All pages on this site define the following access keys:</p>
<ul>
<li>no access keys defined</li>
...
<li>All pages on this site <a href="http://validator.w3.org/">validate as <acronym title="extensible hypertext markup language">XHTML</acronym> 1.0 Strict</a>.  This is not a question of judgment; a program can determine with 100% accuracy whether a page is valid XHTML.  For example, you can click here to <a href="http://validator.w3.org/check?uri=referer">check this  page for XHTML validity</a>.</li>

<li>All pages on this site use structured semantic markup language.  H2 tags are used for main titles, H3 tags for subtitles.  For example, on this page, JAWS users can skip to the next section within the accessibility statement by pressing <kbd>ALT+INSERT+3</kbd>.</li>
</ol>
<h2>Navigation aids</h2>
<ol>
<li>All pages have <tt>rel=previous, next, up,</tt> and <tt>home</tt> links to aid navigation in text-only browsers.  Netscape 6 and Mozilla users can also take advantage of this feature by opening the View menu, and selecting Show/Hide, Site Navigation Bar, Show Only As Needed (or Show Always).</li>

<li>All pages include a search box (access key 4).  Advanced search options are available on the <a href="index.php?name=Search">advanced search page</a>.</li>
</ol>
<h2>Links</h2>
<ol>
