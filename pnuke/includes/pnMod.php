<?php
// $Id: pnMod.php,v 1.64 2006/01/22 14:33:56 drak Exp $
// ----------------------------------------------------------------------
 ...
 */
function pnModGetVar($modname, $name='', $default=null)
{
...
function pnModLangLoad($modname, $type = 'user', $api = false)
{
    ...
    /*
     * LDH - dbg via nestormateo - damn DonateReg lang load prob
     *     As it tunrs out, this funct is called recursively, 1st by Xanthia, then thrice by
     *     somebody recursing thru a list of possible lang file locations.
    echo "Load Lang:modules/$osdirectory/pnlang/$currentlang/{$ostype}{$osapi}.php";
     */
