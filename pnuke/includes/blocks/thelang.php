...
/*
 *  LDH - I believe this is the support for the language block one can make visible
 *  thru the admin UI. It will collect up all the supportable languages and collect
 *   up all world flags (just what country has to do w/ lingo is beyond me)
 */
