...
define('_MENU_AS_DROPDOWN','Display menu as dropdown');
define('_MENU_AS_LIST','Display menu as bulleted list');
define('_MENU_AS_UNBULLETED','Display menu as unbulleted list');
