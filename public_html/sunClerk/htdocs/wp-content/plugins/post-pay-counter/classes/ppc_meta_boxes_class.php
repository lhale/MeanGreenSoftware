...
class PPC_meta_boxes {
    ...
    */
    ...
    static function meta_box_misc_settings( $post, $current_settings ) {
        ...
        echo '<div class="ppc_title">'.__( 'Overall stats' , 'ppc').'</div>';
        echo '<div class="main">';
        ...
        echo '<div class="ppc_section">';
        echo '<div class="ppc_title">'.__( 'Allowed post types' , 'ppc').'</div>';
        echo '<div class="main">';
        ...
        echo '<div class="ppc_section">';
        echo '<div class="ppc_title">'.__( 'Allowed user roles' , 'ppc').'</div>';
        echo '<div class="main">';
        ...
        echo '<div class="ppc_section">';
        echo '<div class="ppc_title">'.__( 'Options page permissions' , 'ppc').'</div>';
        echo '<div class="main">';
        ...
        echo '<div class="ppc_section">';
        echo '<div class="ppc_title">'.__( 'Stats page permissions' , 'ppc').'</div>';
        echo '<div class="main">';
        ...
        echo '<div class="ppc_section">';
        echo '<div class="ppc_title">'.__( 'Default stats time range' , 'ppc').'</div>';
        echo '<div class="main">';
    ...
    */
    ...
    static function meta_box_counting_settings( $post, $current_settings ) {
        ...
        //Basic payment
        echo '<div class="ppc_section">';
        echo '<div class="ppc_title">'.__( 'Basic payment' , 'ppc').'</div>';
        echo '<div class="main">';
        ...
        echo '<div class="ppc_title">'.__( 'Counting options' , 'ppc').'</div>';
        ...
        //Total payment
        echo '<div class="ppc_section">';
        echo '<div class="ppc_title">'.__( 'Total payment' , 'ppc').'</div>';
        echo '<div class="main">';
        ...
        //Misc
        echo '<div class="ppc_section">';
        echo '<div class="ppc_title">'.__( 'Miscellanea counting settings' , 'ppc').'</div>';
        echo '<div class="main">';
