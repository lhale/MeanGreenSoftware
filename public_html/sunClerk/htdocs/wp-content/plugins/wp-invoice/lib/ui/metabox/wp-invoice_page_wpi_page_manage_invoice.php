...
function postbox_payment_methods($this_invoice) {
  ...
  require('/opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/wp-invoice/debug.php');
  
  if (!empty($this_invoice['billing'])) {
log_btrace("Not Empty:");
  error_log(print_r($this_invoice['billing'],  TRUE));	// not writing out to the error log - hmmm
